    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-stone-50 to-amber-50 dark:from-[#0f0d1a] dark:via-[#1a1625] dark:to-[#0f0d1a] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#1a1625] rounded-2xl shadow-sm dark:shadow-violet-900/10 border border-stone-200 dark:border-violet-900/30 p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h2 className="text-xl font-semibold text-stone-800 dark:text-violet-100 mb-2">创建账号</h2>
          <p className="text-stone-500 dark:text-violet-300/70">开始您的写作之旅</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="fullName" className="block text-sm font-medium text-stone-700 dark:text-violet-200 mb-1">
              姓名（可选）
            </label>
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-stone-400 dark:text-violet-400/50" />
              <input
                id="fullName"
                type="text"
                value={fullName}
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-stone-700 dark:text-violet-200 mb-1">
              确认密码
            </label>
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-stone-400 dark:text-violet-400/50" />
        ...
        <p className="mt-6 text-center text-stone-500 dark:text-violet-300/70 text-sm">
          已有账号？{' '}
          <Link href="/login" className="text-stone-700 dark:text-violet-300 font-medium hover:underline">
            登录
          </Link>
        </p>
      </div>
